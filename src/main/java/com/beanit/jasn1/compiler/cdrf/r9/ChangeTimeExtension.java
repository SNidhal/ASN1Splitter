...
public class ChangeTimeExtension implements BerType, Serializable {
	...
	private TimeStampExtension changeTime = null;
	...
	public void setChangeTime(TimeStampExtension changeTime) {
		this.changeTime = changeTime;
	}

	public TimeStampExtension getChangeTime() {
		return changeTime;
	}
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			changeTime = new TimeStampExtension();

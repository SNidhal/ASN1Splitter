...
public class SGSNLCTRecord implements BerType, Serializable {
	...
	public SGSNLCTRecord() {
	}

	public SGSNLCTRecord(byte[] code) {
		this.code = code;
	}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (lcsClientType != null) {
			...
			sb.append("lcsClientType: <empty-required-field>");
		}
		...
		if (lcsClientIdentity != null) {
			...
			sb.append("lcsClientIdentity: <empty-required-field>");
		}
		...
		if (locationType != null) {
			...
			sb.append("locationType: <empty-required-field>");
		}
		...
		if (mlcNumber != null) {
			...
			sb.append("mlcNumber: <empty-required-field>");
		}
